...
<div class="w-full px-4 sm:px-6 lg:px-8 py-5">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="relative">
                    ...
                    <input
                        type="text"
                        class="role-search w-full sm:w-64 pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 placeholder-gray-400 outline-none focus:bg-white focus:border-green-400 focus:ring-2 focus:ring-green-100 transition"
                        placeholder="Search users..."
                    >
                </div>
                <!-- ROLE FILTER -->
                <select
                    class="role-filter w-full sm:w-40 px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 outline-none focus:bg-white focus:border-green-400 focus:ring-2 focus:ring-green-100 transition cursor-pointer"
                >
                    <option value="all">
                        All Roles
                    </option>
    ...
    <div class="min-h-210">
        ...
        <div class="role-error hidden flex-col items-center justify-center py-16 text-center">
            ...
            <p class="role-error-message text-sm text-gray-500 mt-1">
