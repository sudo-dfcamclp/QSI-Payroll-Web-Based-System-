<div class="w-full px-4 sm:px-6 lg:px-8 py-5">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5 mb-6">
        ...
        <div class="flex items-center gap-6 mt-6 border-b border-gray-100">
            <button
                type="button"
                id="activeUserTab"
                class="relative pb-3 text-sm font-semibold text-green-600 transition cursor-pointer"
            >
                Active Users
            ...
            <button
                type="button"
                id="deletedUserTab"
                class="relative pb-3 text-sm font-medium text-gray-500 hover:text-gray-700 transition cursor-pointer"
            >
                Deleted Users
    ...
    <div id="deletedUsersContent" class="hidden">
        ...
        <div class="min-h-210">
            ...
            >
                <div class="w-14 h-14 rounded-full bg-gray-50 flex items-center justify-center mb-4">
                    <i class="fa-solid fa-trash-can text-gray-300 text-xl"></i>
                </div>
                <h3 class="text-sm font-semibold text-gray-700">
                    No deleted users
                </h3>
