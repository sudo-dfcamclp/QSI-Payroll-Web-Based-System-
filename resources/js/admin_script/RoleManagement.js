...
function createUserCard(user){
    ...
    if(profile){
        ...
        profileDisplay=`
            ...
            <div class="hidden w-11 h-11 rounded-full bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400 items-center justify-center font-semibold shrink-0">
